...
@NamedQueries({
  ...
  @NamedQuery(name = "ItemAccount.findById", query = "SELECT i FROM ItemAccount i WHERE i.id = :id")
    ,
  @NamedQuery(name = "ItemAccount.findByLendNum", query = "SELECT i FROM ItemAccount i WHERE i.lendNum = :lendNum")
    ,
  @NamedQuery(name = "ItemAccount.findByTimeCheck", query = "SELECT i FROM ItemAccount i WHERE i.timeCheck = :timeCheck")
    ,
  @NamedQuery(name = "ItemAccount.findByStuffAndItemAndFlag", query = "SELECT i FROM ItemAccount i WHERE i.stuff = :stuff and i.item = :item and i.flag = :flag")
    ,
