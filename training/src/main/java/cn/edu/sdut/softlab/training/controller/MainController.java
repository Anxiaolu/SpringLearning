package cn.edu.sdut.softlab.training.controller;

import cn.edu.sdut.softlab.training.model.UserEntity;
import cn.edu.sdut.softlab.training.repository.UserRepository;
...
public class MainController {
  ...
  /**
   * 查看用户详细信息.
   * 收集url中的变量，需匹配的变量用{}括起来.
   * 例如：访问 localhost:8080/showUser/1 ，将匹配 userId = 1
   * @param userId 浏览器输入的userId
   * @param modelMap ？？
   * @return String 导航页面
   */
